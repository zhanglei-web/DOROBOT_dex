...
# from teleop import MocapUpperBodyTeleVisionWrapper
...
class TelepDataCollector:  
    ...
    def collect_data(self):  
        try:  
            ...
            head_pose,left_wrist_pose,right_wrist_pose,left_finger_joints,right_finger_joints = self.teleop.get_data()  
            # 发送到 Dora 数据流  
